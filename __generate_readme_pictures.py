...
con_img.resize((img.width // 2, img.height // 2)).save('example/compressed.jpg', optimize=True, quality=50)
con_compressed = Image.open('example/compressed.jpg')
deconfuse(con_compressed, DEFAULT_SEED).save('example/final.jpg')
img.resize((img.width // 2, img.height // 2)).save('example/comparison.jpg', optimize=True, quality=50)
